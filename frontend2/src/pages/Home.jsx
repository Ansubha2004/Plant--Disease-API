        ...
        <div className={clsx("px-30 w-full flex justify-center gap-6",preview?"items-start":"")}>
          <div id="product" className="w-2/3 py-[60px] border-dashed rounded-[32px] border-[#C1C8C24D] bg-white/70 border-[5px] flex flex-col justify-center items-center backdrop-blur-sm">
            ...
            <div className="flex justify-center items-center  px-1   gap-3 mt-2">
              <div className="flex  gap-2 bg-white px-1   overflow-x-hidden whitespace-nowrap w-60 py-1 border-box  rounded-lg items-center">
                <div className="flex  items-center">
                  <label className="bg-[#012D1D10] text-[#012D1D] py-1 px-2 rounded-lg buttonanimate cursor-pointer manrope text-[0.9rem] manrope">
                    Choose File
                    <input
                      type="file"
                      accept="image/*"
